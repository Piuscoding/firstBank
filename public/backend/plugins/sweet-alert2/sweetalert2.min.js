!function(t, e) {
    ...
    function R(t, e, n) {
        ...
        e.customClass && e.customClass[n]) {
            if ("string" != typeof e.customClass[n] && !e.customClass[n].forEach)
                return D("Invalid type of customClass.".concat(n, '! Expected string or iterable object, got "').concat(r(e.customClass[n]), '"'));
    ...
    function nt(t, e) {
        var n = 1 < arguments.length && void 0 !== e && e
          , o = H();
        dt(o) && (n && (o.style.transition = "none",
        o.style.width = "100%"),
        setTimeout(function() {
    ...
    var ct, st = function(t, e) {
        ...
        if (!function() {
            ...
            ut([document.documentElement, document.body], [z["no-backdrop"], z["toast-shown"], z["has-column"]]))
        }(),
        ot())
            h("SweetAlert2 requires document to initialize");
        else {
            var e = document.createElement("div");
            e.className = z.container,
            e.innerHTML = pt;
            var n = function(t) {
    ...
    function vt(t, e) {
        ...
        if (n) {
            ...
            function(t, e) {
                e in z ? st(t, z[e]) : (D('The "position" parameter is not valid, defaulting to "center"'),
                st(t, z.center))
            }(n, e.position),
            function(t, e) {
    ...
    Pt.text = Pt.email = Pt.password = Pt.number = Pt.tel = Pt.url = function(t, e) {
        return "string" == typeof e.inputValue || "number" == typeof e.inputValue ? t.value = e.inputValue : v(e.inputValue) || D('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(r(e.inputValue), '"')),
        bt(t, e),
        t.type = e.input,
        t
    }
    ...
    function Bt(t, e) {
        ...
        e.html ? (rt(e.html, n),
        X(n, "block")) : e.text ? (n.textContent = e.text,
        X(n, "block")) : G(n),
        function(t, o) {
            var i = A()
    ...
    function St(t, i) {
        ...
        a >= i.progressSteps.length && D("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"),
        i.progressSteps.forEach(function(t, e) {
            var n = function(t) {
                var e = document.createElement("li");
                return st(e, z["progress-step"]),
                e.innerHTML = t,
                e
            }(t);
            if (r.appendChild(n),
            ...
            e !== i.progressSteps.length - 1) {
                var o = function(t) {
                    var e = document.createElement("li");
                    return st(e, z["progress-step-line"]),
        ...
        function(t, e) {
            ...
            e.icon)
                if (-1 !== Object.keys(W).indexOf(e.icon)) {
                    ...
                    h('Unknown icon! Expected "success", "error", "warning", "info" or "question", got "'.concat(e.icon, '"'))
        }(t, e),
        function(t, e) {
            var n = P();
            if (!e.imageUrl)
    ...
    var Mt = function() {
      ...
      , Ht = function() {
        for (var t = C(), e = window.getComputedStyle(t).getPropertyValue("background-color"), n = t.querySelectorAll("[class^=swal2-success-circular-line], .swal2-success-fix"), o = 0; o < n.length; o++)
            n[o].style.backgroundColor = e
    }
      , jt = function(t, e) {
        if (t.innerHTML = "",
        e.iconHtml)
            t.innerHTML = Vt(e.iconHtml);
      ...
      , It = []
      , qt = function(t, e) {
        t.className = "".concat(z.popup, " ").concat(dt(t) ? e.showClass.popup : ""),
        e.toast ? (st([document.documentElement, document.body], z["toast-shown"]),
        st(t, z.toast)) : st(t, z.modal),
        R(t, e, "popup"),
    ...
    function Nt() {
        return new Promise(function(t) {
            ...
            zt.restoreFocusTimeout = setTimeout(function() {
                zt.previousActiveElement && zt.previousActiveElement.focus ? (zt.previousActiveElement.focus(),
                zt.previousActiveElement = null) : document.body && document.body.focus(),
                t()
            }, 100),
      ...
      , Qt = Object.freeze({
        ...
        queue: function(t) {
            ...
            return new Promise(function(i) {
                !function e(n, o) {
                    n < It.length ? (document.body.setAttribute("data-swal2-queue-step", n),
    ...
    function $t() {
        ...
        if (t) {
            ...
            t.showConfirmButton || (G(e.confirmButton),
            t.showCancelButton || G(e.actions)),
    ...
    function Jt() {
        ...
        document.body.style.paddingRight = "".concat(Y.previousBodyPadding + function() {
            var t = document.createElement("div");
    ...
    function ne(t, e, n, o) {
        ...
        I() && (null !== Y.previousBodyPadding && (document.body.style.paddingRight = "".concat(Y.previousBodyPadding, "px"),
        ...
        "undefined" != typeof window && Xt() && window.removeEventListener("resize", Gt),
    ...
    var re = function(t, e, n, o) {
        ...
        e.addEventListener(ht, function(t) {
            t.target === e && (zt.swalCloseEventFinishedCallback(),
    ...
    function fe(t) {
        ...
        K() || zt.previousActiveElement || (zt.previousActiveElement = document.activeElement),
    ...
    function we(t, e, n) {
        e.toast ? De(t, e, n) : (Fe(t),
        _e(t),
        ze(t, e, n))
    }
    var Ce = function(e, n) {
        ht && et(n) ? (e.style.overflowY = "hidden",
      ...
      , xe = function(t, e, n) {
        ...
        n.heightAuto && n.backdrop && !n.toast && st([document.documentElement, document.body], z["height-auto"])
    }
      , Ae = function(t) {
      ...
      , Oe = function(e, n) {
        ...
        })) : e.getInput().checkValidity() ? Me(e, n, o) : (e.enableButtons(),
      ...
      , Ve = function(t, e, n, o) {
        ...
        "Enter" === e.key ? Ie(t, e, n) : "Tab" === e.key ? qe(e, n) : -1 !== He.indexOf(e.key) ? Re() : -1 !== je.indexOf(e.key) && Ne(e, n, o)
    }
      , Ie = function(t, e, n) {
    ...
    var We = function(t, e, n) {
        var o = H();
        G(o),
        e.timer && (t.timeout = new ue(function() {
            n("timer"),
            delete t.timeout
        }
        ,e.timer),
        e.timerProgressBar && (X(o),
        setTimeout(function() {
            nt(e.timer)
        })))
    }
      , Ke = function(t, e) {
        if (!e.toast)
            return F(e.allowEnterKey) ? e.focusCancel && dt(t.cancelButton) ? t.cancelButton.focus() : e.focusConfirm && dt(t.confirmButton) ? t.confirmButton.focus() : void ye(0, -1, 1) : Ye()
    }
      , Ye = function() {
        ...
        _main: function(t) {
            !function(t) {
                for (var e in t)
                    ...
                    t.toast && (o = e,
                    -1 !== Zt.indexOf(o) && D('The parameter "'.concat(o, '" is incompatible with toasts'))),
                    _t(n = e) && g(n, _t(n));
                var n, o, i
            }(t),
            C() && zt.swalCloseEventFinishedCallback && (zt.swalCloseEventFinishedCallback(),
            delete zt.swalCloseEventFinishedCallback),
            zt.deferDisposalTimer && (clearTimeout(zt.deferDisposalTimer),
    ...
    Object.keys(Qe).forEach(function(e) {
        $e[e] = function() {
            var t;
            if (Ze)
                return (t = Ze)[e].apply(t, arguments)
        }
    }),
    $e.DismissReason = _,
    $e.version = "9.5.3";
